...
public class ModelRabbit extends ModelBase {
	...
	public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale) {
		...
		if (isChild) {
			float f6 = 2.0F;
			OpenGLHelperExtend.pushMatrix();
			OpenGLHelperExtend.translate(0.0F, 5.0F * scale, 2.0F * scale);
			rabbitHead.render(scale);
			rabbitLeftEar.render(scale);
			rabbitRightEar.render(scale);
			rabbitNose.render(scale);
			OpenGLHelperExtend.popMatrix();
			OpenGLHelperExtend.pushMatrix();
			OpenGLHelperExtend.scale(1.0F / f6, 1.0F / f6, 1.0F / f6);
			OpenGLHelperExtend.translate(0.0F, 24.0F * scale, 0.0F);
