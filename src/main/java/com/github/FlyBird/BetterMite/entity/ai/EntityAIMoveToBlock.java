package com.github.FlyBird.BetterMite.entity.ai;
			...
			for (int k = 0; k < i; ++k)
				for (int l = 0; l <= k; l = l > 0 ? -l : 1 - l)
					for (int i1 = l < k && l > -k ? k : 0; i1 <= k; i1 = i1 > 0 ? -i1 : 1 - i1) {
						...
						if (theEntity.func_110176_b(blockpos1.getX(), blockpos1.getY(), blockpos1.getZ()) && shouldMoveTo(theEntity.worldObj, blockpos1)) {
