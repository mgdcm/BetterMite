...
import com.github.FlyBird.BetterMite.item.ItemNewBoat;
...
//			System.out.print("啊哈哈");
	...
	protected void readEntityFromNBT(NBTTagCompound compound) {
		...
		if (NBTTagCompoundExtend.hasKey("Type", 8,compound)) {
			this.setBoatType( compound.getString("Type"));
		} else {
			this.setBoatType( "oak");
		}
//ConfigBlocksItems.newBoatPassengerSeat &&
		...
		if (NBTTagCompoundExtend.hasKey("CustomName", 9,compound) && compound.getString("CustomName").length() > 0) {
