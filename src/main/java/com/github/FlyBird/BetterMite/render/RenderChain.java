...
public class RenderChain {
    public static RenderChain instance=new RenderChain();

    public void drawChain(Block par1Block, int metadata, int x, int y, int z, Icon photo, IBlockAccess blockAccess) {
